    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submission_file', models.FileField(upload_to='content/submissions/submission_dbe75fa526e94ecc82deebb580ecf242<django.db.models.fields.CharField>')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('testcase_id', models.CharField(default='a8f1fac655034f6585f24fb5be3d1692', max_length=32, primary_key=True, serialize=False)),
                ('inputfile', models.FileField(default='./default/inputfile.txt', upload_to='content/testcase/inputfile_a8f1fac655034f6585f24fb5be3d1692.txt')),
                ('outputfile', models.FileField(default='./default/outputfile.txt', upload_to='content/testcase/outputfile_a8f1fac655034f6585f24fb5be3d1692.txt')),
                ('problem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='judge.Problem')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='Comment',
            fields=[
                ('comment_id', models.CharField(default='e07612f1c5e249ab98753cea00d9448d', max_length=32, primary_key=True, serialize=False)),
                ('comment', models.FileField(default='./default/comment.yml', upload_to='content/comment/e07612f1c5e249ab98753cea00d9448d.yml')),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='judge.Person')),
                ('problem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='judge.Problem')),
            ],
        ),
