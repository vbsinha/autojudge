    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submission_file', models.FileField(upload_to='content/submissions/submission_b10eed3f654f46eb82046a60fa1371e0<django.db.models.fields.CharField>')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('testcase_id', models.CharField(default='a4faa634e4964769902ffe595c587e79', max_length=32, primary_key=True, serialize=False)),
                ('inputfile', models.FileField(default='./default/default_inputfile.yml', upload_to='content/testcase/inputfile_a4faa634e4964769902ffe595c587e79.txt')),
                ('outputfile', models.FileField(default='./default/default_outputfile.yml', upload_to='content/testcase/outputfile_a4faa634e4964769902ffe595c587e79.txt')),
                ('problem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='judge.Problem')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='Comment',
            fields=[
                ('comment_id', models.CharField(default='a6a3079249534f59b6b3c70dca6978d6', max_length=32, primary_key=True, serialize=False)),
                ('comment', models.FileField(default='./default/default_comment.yml', upload_to='content/comment/a6a3079249534f59b6b3c70dca6978d6.yml')),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='judge.Person')),
                ('problem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='judge.Problem')),
            ],
        ),
