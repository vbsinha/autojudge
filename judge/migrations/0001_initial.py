# Generated by Django 2.2 on 2019-04-11 06:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submission_file', models.FileField(upload_to='content/submissions/submission_59acba19503041f3873ba677bbef9330<django.db.models.fields.CharField>')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('testcase_id', models.CharField(default='60ecef70ed1b4d9c854ab4f10812e737', max_length=32, primary_key=True, serialize=False)),
                ('inputfile', models.FileField(default='./default/inputfile.txt', upload_to='content/testcase/inputfile_60ecef70ed1b4d9c854ab4f10812e737.txt')),
                ('outputfile', models.FileField(default='./default/outputfile.txt', upload_to='content/testcase/outputfile_60ecef70ed1b4d9c854ab4f10812e737.txt')),
                ('problem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='judge.Problem')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='Comment',
            fields=[
                ('comment_id', models.CharField(default='18b0323b300147429a2f06a76ef2cd72', max_length=32, primary_key=True, serialize=False)),
                ('comment', models.FileField(default='./default/comment.yml', upload_to='content/comment/18b0323b300147429a2f06a76ef2cd72.yml')),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='judge.Person')),
                ('problem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='judge.Problem')),
            ],
        ),
