    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submission_file', models.FileField(upload_to='content/submissions/submission_0c523ea57f754c12aaf3e25835b0c0fa<django.db.models.fields.CharField>')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('testcase_id', models.CharField(default='bdea5f0cec094d5d82c4e8ca4671e82a', max_length=32, primary_key=True, serialize=False)),
                ('inputfile', models.FileField(default='./default/inputfile.txt', upload_to='content/testcase/inputfile_bdea5f0cec094d5d82c4e8ca4671e82a.txt')),
                ('outputfile', models.FileField(default='./default/outputfile.txt', upload_to='content/testcase/outputfile_bdea5f0cec094d5d82c4e8ca4671e82a.txt')),
                ('problem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='judge.Problem')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='Comment',
            fields=[
                ('comment_id', models.CharField(default='fdcf339f1c914e9890e5914d18852697', max_length=32, primary_key=True, serialize=False)),
                ('comment', models.FileField(default='./default/comment.yml', upload_to='content/comment/fdcf339f1c914e9890e5914d18852697.yml')),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='judge.Person')),
                ('problem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='judge.Problem')),
            ],
        ),
