# Generated by Django 2.2 on 2019-04-19 09:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submission_file', models.FileField(upload_to='content/submissions/submission_d020448640cd48ddb07a037b431fba85<django.db.models.fields.CharField>')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('public', models.BooleanField()),
                ('inputfile', models.FileField(default='./default/inputfile.txt', upload_to='content/testcase/inputfile_686dce2c61514075a82ebede6ce19e35.txt')),
                ('outputfile', models.FileField(default='./default/outputfile.txt', upload_to='content/testcase/outputfile_686dce2c61514075a82ebede6ce19e35.txt')),
                ('problem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='judge.Problem')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='Comment',
            fields=[
                ('comment_id', models.CharField(default='935bac35d54840e488dd6cf1188ac8fe', max_length=32, primary_key=True, serialize=False)),
                ('comment', models.FileField(default='./default/comment.yml', upload_to='content/comment/935bac35d54840e488dd6cf1188ac8fe.yml')),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='judge.Person')),
                ('problem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='judge.Problem')),
            ],
        ),
